...
Once Laravel Paystack is installed, you need to register the service provider. Open up `bootstrap/providers.php` and add the following to the `providers` key.
